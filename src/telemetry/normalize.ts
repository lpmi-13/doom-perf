...
const readMemory = (payload: Record<string, unknown>): MemoryTelemetry => {
  ...
  return {
    ...
    minorFaultsPerSecond: numberValue(source.minorFaultsPerSecond),
    majorFaultsPerSecond: numberValue(source.majorFaultsPerSecond),
    pressureAvailable: source.pressureAvailable === true,
    ...
    refaultPagesPerSecond: numberValue(source.refaultPagesPerSecond),
...
const readNetwork = (payload: Record<string, unknown>): NetworkTelemetry => {
  ...
  return {
    ...
    recvBufOverflowsPerSecond: numberValue(source.recvBufOverflowsPerSecond),
    sendBufOverflowsPerSecond: numberValue(source.sendBufOverflowsPerSecond),
